"""Scrape Just Aircraft listings from Barnstormers.com and render them into
...
PAGE_TITLE = "Other Just Aircraft Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    (
        "Trade-A-Plane",
        "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=just%20aircraft&s-original-search=just%20aircraft",
    ),
    ("Controller", "https://www.controller.com/listings?keywords=just%20aircraft"),
    ("ASO", "https://aso.com/search?q=Just%20Aircraft"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More Just Aircraft Listings</h2>
    <p>View additional Just Aircraft listings at these fine sites:</p>
